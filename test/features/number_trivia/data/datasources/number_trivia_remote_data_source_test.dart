...
void main() {
  late HttpNumberTriviaRemoteDataSource dataSource;
  late MockHttpClient mockHttpClient;

  setUp(() {
    mockHttpClient = MockHttpClient();
    dataSource = HttpNumberTriviaRemoteDataSource(client: mockHttpClient);
  });
  ...
  group('getConcreteNumberTrivia', () {
    ...
    final tNumberTriviaModel =
        NumberTriviaResponseModel.fromJson(json.decode(fixture('trivia')));
